...
class AnamneseGigantePsicopedaNeuroPsicomotoPt1 extends Model {
    ...
    protected $fillable = [
            ...
            'teve_ictericia',
            'idade_gestacional_do_bebê_ao_nascer',
    ...
    public static $regras_validacao = [
            ...
            'compareceram_entrevista' => 'required',
            'queixa' => 'required',
            'escolaridade' => 'required',
            'convulcoes' => 'required',
            'como_era_composta_a_familia_na_epoca_da_concepcao' => 'required',
            'gestacoes_anteriores' => 'required',
            'abortos' => 'required',
            'naturais' => 'required',
            'provocados' => 'required',
            'perdeu_algum_filho' => 'required',
            'como_foi_a_aceitacao_das_familias' => 'required',
            'gravidez_planejada_por_ambos' => 'required',
            'fez_tratamento_pre_natal' => 'required',
            'enjoo' => 'required',
            'bebeu' => 'required',
            'fumou' => 'required',
            'ja_tinham_outros_filhos_se_sim_quantos' => 'required',
            'aceitou_bem_a_alimentação_pastosa' => 'required',
            'aceitou_bem_a_alimentação_solida' => 'required',
            'usa_copo' => 'required',
            'alimentacao_atual' => 'required',
            'retardo_diabetes_síndromes_doenças_nervosas_epilepsia' => 'required',
            'teve_sarampo_infancia' => 'required',
            'teve_dores_ouvido_infancia' => 'required',
            'teve_colicas_infancia' => 'required',
            'teve_catapora_infancia' => 'required',
            'teve_caxumba_infancia' => 'required',
            'teve_rubeola_infancia' => 'required',
            'teve_coqueluche_infancia' => 'required',
            'teve_meningite_infancia' => 'required',
            'teve_desidratacao_infancia' => 'required',
