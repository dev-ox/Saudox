        ...
        <div class="row">
            ...
            <div style="text-align: center; width: 100%;">
                <div class = "caixa_form">
                    <br>
                    <h1>Editar a avaliação de Neuropsicologia/Terapia Ocupacional/PsicoMotricidade de <br>{{$paciente->nome_paciente}}</h1>

                    <form method="post" action="{{route('profissional.avaliacao.neuropsicologia.editar.salvar')}}" enctype="multipart/form-data">
                        ...
                        <div class="text-center justify-content-center" style="width: 90%; margin:auto;" >
                            <table class="tabelao_input table table-dark justify-content-center text-center" id="tabela_atividades_para_ser_feito_na_clinica">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    @foreach($tabela_atividades_para_ser_feito_na_clinica as $idx => $atividade_clinica)
                                        <tr>
                                            <td><textarea required class="textareas_form" row="4" cols="10" name="atividades_para_ser_feito_na_clinica[{{$idx}}][nome_atividade]">{{ $atividade_clinica->nome_atividade }}</textarea></td>
                                            <td><textarea required class="textareas_form" row="4" cols="10" name="atividades_para_ser_feito_na_clinica[{{$idx}}][recursos_utilizados]">{{ $atividade_clinica->recursos_utilizados }}</textarea></td>
                                            <td><textarea required class="textareas_form" row="4" cols="10" name="atividades_para_ser_feito_na_clinica[{{$idx}}][tempo_de_duracao]">{{ $atividade_clinica->tempo_de_duracao }}</textarea></td>
                                            <td><textarea required class="textareas_form" row="4" cols="10" name="atividades_para_ser_feito_na_clinica[{{$idx}}][funcao_cognitiva]">{{ $atividade_clinica->funcao_cognitiva }}</textarea></td>
                                            <td><textarea required class="textareas_form" row="4" cols="10" name="atividades_para_ser_feito_na_clinica[{{$idx}}][objetivo]">{{ $atividade_clinica->objetivo }}</textarea></td>
                                            <td><textarea required class="textareas_form" row="4" cols="10" name="atividades_para_ser_feito_na_clinica[{{$idx}}][resultados]">{{ $atividade_clinica->resultados }}</textarea></td>
                        ...
                        <div class="text-center justify-content-center" style="width: 90%; margin:auto;" >
                            <table class="tabelao_input table table-dark justify-content-center text-center" id="tabela_atividades_para_ser_feito_em_casa">
                                <thead>
                                    <tr>
                                        <th scope="col">Nome da atividade</th>
                                        <th scope="col">Recurso utilizado</th>
                                ...
                                <tbody>
                                    ...
                                    @foreach($tabela_atividades_para_ser_feito_em_casa as $idx => $atividade_casa)
                                        <tr>
                                            <td><textarea required class="textareas_form" row="4" cols="10" name="atividades_para_ser_feito_em_casa[{{$idx}}][nome_atividade]">{{ $atividade_casa->nome_atividade }}</textarea></td>
                                            <td><textarea required class="textareas_form" row="4" cols="10" name="atividades_para_ser_feito_em_casa[{{$idx}}][recursos_utilizados]">{{ $atividade_casa->recursos_utilizados }}</textarea></td>
                                            <td><textarea required class="textareas_form" row="4" cols="10" name="atividades_para_ser_feito_em_casa[{{$idx}}][tempo_de_duracao]">{{ $atividade_casa->tempo_de_duracao }}</textarea></td>
                                            <td><textarea required class="textareas_form" row="4" cols="10" name="atividades_para_ser_feito_em_casa[{{$idx}}][funcao_cognitiva]">{{ $atividade_casa->funcao_cognitiva }}</textarea></td>
                                            <td><textarea required class="textareas_form" row="4" cols="10" name="atividades_para_ser_feito_em_casa[{{$idx}}][objetivo]">{{ $atividade_casa->objetivo }}</textarea></td>
                                            <td><textarea required class="textareas_form" row="4" cols="10" name="atividades_para_ser_feito_em_casa[{{$idx}}][resultados]">{{ $atividade_casa->resultados }}</textarea></td>
                                            <td style="vertical-align: middle;"><a onclick="remover_linha(this)" class="bt" style="margin: auto;width: 25px; padding:0px; cursor: pointer;">X</a></td>
                                        </tr>
                                    @endforeach
