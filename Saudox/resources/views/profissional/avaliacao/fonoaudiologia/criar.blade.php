...
@section('content')
    ...
    <div id="container_blocos_questionarios" style="display: none;">
        ...
        <div id="bloco_12_17_meses">
            ...
            <h4>1. Mantém a atenção <i>(por dois minutos)</i>.<input name="respostas[quest_12_17][]" type="text" /></h4><br>
            ...
            <i>
                ...
                último atrás da criança, observando se ela procura a fonte sonora. <input name="respostas[quest_12_17][]" type="text" /><br><br>
                ...
                contrário e para cima, observando se a criança acompanha com o olhar o movimento realizado). <input name="respostas[quest_12_17][]" type="text" /><br><br>
            </i>

            <br><br><br><br>

            <h4>2. Compreende ordens simples com pistas gestuais. <input name="respostas[quest_12_17][]" type="text" /></h4><br>
            (1 ponto = 2 acertos) <br><br>
            ...
            <i>
                ...
                a. Pegue a bola. <input name="respostas[quest_12_17][]" type="text" /><br><br>
                b. Dê a bola para mim. <input name="respostas[quest_12_17][]" type="text" /><br><br>
                c. Agora, dê a bola para o neném. <input name="respostas[quest_12_17][]" type="text" /><br><br>
            </i>

            <br><br><br><br>

            <h4>3. Identifica objetos familiares. <input name="respostas[quest_12_17][]" type="text" /></h4><br>
            ...
            <i>
                ...
                a. a bola <input name="respostas[quest_12_17][]" type="text" /><br><br>
                b. o carro <input name="respostas[quest_12_17][]" type="text" /><br><br>
                c. a neném <input name="respostas[quest_12_17][]" type="text" /><br><br>
                d. o cachorro <input name="respostas[quest_12_17][]" type="text" /><br><br>

            </i>

            <br><br><br><br>

            <h4>4. Identifica figuras. <input name="respostas[quest_12_17][]" type="text" /></h4><br>
            ...
            <h4>1. Produz sons silábicos variados (faz combinação de sons). <input name="respostas[quest_12_17][]" type="text" /></h4>
            ...
            <h4>2.Possui vocabulário de pelo menos uma palavra: <input name="respostas[quest_12_17][]" type="text" /></h4>
            ...
            <h4>3.Comunica-se de forma não verbal, usando gestos, chamando atenção <br>
                para si ou apontando para um objeto ou pessoa. <input name="respostas[quest_12_17][]" type="text" /></h4>
            ...
            <h4>4.Imita uma palavra. <input name="respostas[quest_12_17][]" type="text" /></h4>
