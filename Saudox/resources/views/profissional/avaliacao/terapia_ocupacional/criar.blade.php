            ...
            <div style="text-align: center; width: 100%;">
                <div class = "caixa_form">
                    ...
                    <form method="post" action="{{route('profissional.avaliacao.terapia_ocupacional.criar.salvar')}}">
                        ...
                        <input value="1" type="radio" name="dorme_durante_dia" id="dorme_durante_dia" {{ g_old_checked(NULL, "dorme_durante_dia", "1") }}>
                        <label for="dorme_durante_dia">Não</label>
                        <input value="0" type="radio" name="dorme_durante_dia" id="dorme_durante_dia" {{ g_old_checked(NULL, "dorme_durante_dia", "0") }}><br>

                        <label class="required">Dorme com facilidade?</label><br>
                        <label for="dorme_com_facilidade">Sim</label>
                        <input value="1" type="radio" name="dorme_com_facilidade" id="dorme_com_facilidade" {{ g_old_checked(NULL, "dorme_com_facilidade", "1") }}>
                        <label for="dorme_com_facilidade">Não</label>
                        <input value="0" type="radio" name="dorme_com_facilidade" id="dorme_com_facilidade" {{ g_old_checked(NULL, "dorme_com_facilidade", "0") }}><br>

                        <label class="required">Tem sono tranquilo?</label><br>
                        <label for="sono_tranqulo">Sim</label>
                        <input value="1" type="radio" name="sono_tranqulo" id="sono_tranqulo" {{ g_old_checked(NULL, "sono_tranqulo", "1") }}>
                        <label for="sono_tranqulo">Não</label>
                        <input value="0" type="radio" name="sono_tranqulo" id="sono_tranqulo" {{ g_old_checked(NULL, "sono_tranqulo", "0") }}><br>
                        ...
                        <input value="1" type="radio" name="pesadelos" id="pesadelos" {{ g_old_checked(NULL, "pesadelos", "1") }}>
                        <label for="pesadelos">Não</label>
                        <input value="0" type="radio" name="pesadelos" id="pesadelos" {{ g_old_checked(NULL, "pesadelos", "0") }}><br>

                        <label class="required">Sonambulismo?</label><br>
                        <label for="sonambulismo">Sim</label>
                        <input value="1" type="radio" name="sonambulismo" id="sonambulismo" {{ g_old_checked(NULL, "sonambulismo", "1") }}>
                        <label for="sonambulismo">Não</label>
                        <input value="0" type="radio" name="sonambulismo" id="sonambulismo" {{ g_old_checked(NULL, "sonambulismo", "0") }}><br>

                        <label class="required">Rola/balança a cabeça?</label><br>
                        <label for="rola_balanca_cabeca_enquanto_dorme">Sim</label>
                        <input value="1" type="radio" name="rola_balanca_cabeca_enquanto_dorme" id="rola_balanca_cabeca_enquanto_dorme" {{ g_old_checked(NULL, "rola_balanca_cabeca_enquanto_dorme", "1") }}>
                        <label for="rola_balanca_cabeca_enquanto_dorme">Não</label>
                        <input value="0" type="radio" name="rola_balanca_cabeca_enquanto_dorme" id="rola_balanca_cabeca_enquanto_dorme" {{ g_old_checked(NULL, "rola_balanca_cabeca_enquanto_dorme", "0") }}><br>
                        ...
                        <input value="1" type="radio" name="come_com_os_dedos" id="come_com_os_dedos" {{ g_old_checked(NULL, "come_com_os_dedos", "1") }}>
                        <label for="come_com_os_dedos">Não</label>
                        <input value="0" type="radio" name="come_com_os_dedos" id="come_com_os_dedos" {{ g_old_checked(NULL, "come_com_os_dedos", "0") }}><br>

                        <label class="required">Come com garfo, colher?</label><br>
                        <label for="come_com_talheres">Sim</label>
                        <input value="1" type="radio" name="come_com_talheres" id="come_com_talheres" {{ g_old_checked(NULL, "come_com_talheres", "1") }}>
                        <label for="come_com_talheres">Não</label>
                        <input value="0" type="radio" name="come_com_talheres" id="come_com_talheres" {{ g_old_checked(NULL, "come_com_talheres", "0") }}><br>

                        <label class="required">Brinca com a comida?</label><br>
                        <label for="brinca_com_comida">Sim</label>
                        <input value="1" type="radio" name="brinca_com_comida" id="brinca_com_comida" {{ g_old_checked(NULL, "brinca_com_comida", "1") }}>
                        <label for="brinca_com_comida">Não</label>
                        <input value="0" type="radio" name="brinca_com_comida" id="brinca_com_comida" {{ g_old_checked(NULL, "brinca_com_comida", "0") }}><br>

                        <label class="required">Derrama a comida?</label><br>
                        <label for="derrama_comida">Sim</label>
                        <input value="1" type="radio" name="derrama_comida" id="derrama_comida" {{ g_old_checked(NULL, "derrama_comida", "1") }}>
                        <label for="derrama_comida">Não</label>
                        <input value="0" type="radio" name="derrama_comida" id="derrama_comida" {{ g_old_checked(NULL, "derrama_comida", "0") }}><br>

                        <label class="required">Usa qual mão para comer?</label><br>
                        <label for="usa_mao_direita_para_comer">Direita</label>
                        <input value="1" type="radio" name="usa_mao_direita_para_comer" id="usa_mao_direita_para_comer" {{ g_old_checked(NULL, "usa_mao_direita_para_comer", "1") }}>
                        <label for="usa_mao_direita_para_comer">Esquerda</label>
                        <input value="0" type="radio" name="usa_mao_direita_para_comer" id="usa_mao_direita_para_comer" {{ g_old_checked(NULL, "usa_mao_direita_para_comer", "0") }}><br>

                        <label class="required">Bebe em garrafa, copo?</label><br>
                        <label for="bebe_em_garrafa">Sim</label>
                        <input value="1" type="radio" name="bebe_em_garrafa" id="bebe_em_garrafa" {{ g_old_checked(NULL, "bebe_em_garrafa", "1") }}>
                        <label for="bebe_em_garrafa">Não</label>
                        <input value="0" type="radio" name="bebe_em_garrafa" id="bebe_em_garrafa" {{ g_old_checked(NULL, "bebe_em_garrafa", "0") }}><br>

                        <label class="required">Usa canudo?</label><br>
                        <label for="usa_canudo">Sim</label>
                        <input value="1" type="radio" name="usa_canudo" id="usa_canudo" {{ g_old_checked(NULL, "usa_canudo", "1") }}>
                        <label for="usa_canudo">Não</label>
                        <input value="0" type="radio" name="usa_canudo" id="usa_canudo" {{ g_old_checked(NULL, "usa_canudo", "0") }}><br>
                        ...
                        <input value="1" type="radio" name="ajuda_a_colocar_a_mesa" id="ajuda_a_colocar_a_mesa" {{ g_old_checked(NULL, "ajuda_a_colocar_a_mesa", "1") }}>
                        <label for="ajuda_a_colocar_a_mesa">Não</label>
                        <input value="0" type="radio" name="ajuda_a_colocar_a_mesa" id="ajuda_a_colocar_a_mesa" {{ g_old_checked(NULL, "ajuda_a_colocar_a_mesa", "0") }}><br>
                        ...
                        <input value="1" type="radio" name="tem_bom_apetite" id="tem_bom_apetite" {{ g_old_checked(NULL, "tem_bom_apetite", "1") }}>
                        <label for="tem_bom_apetite">Não</label>
                        <input value="0" type="radio" name="tem_bom_apetite" id="tem_bom_apetite" {{ g_old_checked(NULL, "tem_bom_apetite", "0") }}><br>
                        ...
                        <input value="1" type="radio" name="houve_dificuldade_transicao_pastoso_solido" id="houve_dificuldade_transicao_pastoso_solido" {{ g_old_checked(NULL, "houve_dificuldade_transicao_pastoso_solido", "1") }}>
                        <label for="houve_dificuldade_transicao_pastoso_solido">Não</label>
                        <input value="0" type="radio" name="houve_dificuldade_transicao_pastoso_solido" id="houve_dificuldade_transicao_pastoso_solido" {{ g_old_checked(NULL, "houve_dificuldade_transicao_pastoso_solido", "0") }}><br>
                        ...
                        <input value="1" type="radio" name="abotoa" id="abotoa" {{ g_old_checked(NULL, "abotoa", "1") }}>
                        <label for="abotoa">Não</label>
                        <input value="0" type="radio" name="abotoa" id="abotoa" {{ g_old_checked(NULL, "abotoa", "0") }}><br>

                        <label class="required">Amarra?</label><br>
                        <label for="amarra">Sim</label>
                        <input value="1" type="radio" name="amarra" id="amarra" {{ g_old_checked(NULL, "amarra", "1") }}>
                        <label for="amarra">Não</label>
                        <input value="0" type="radio" name="amarra" id="amarra" {{ g_old_checked(NULL, "amarra", "0") }}><br>
                        ...
                        <input value="1" type="radio" name="usa_fralda" id="usa_fralda" {{ g_old_checked(NULL, "usa_fralda", "1") }}>
                        <label for="usa_fralda">Não</label>
                        <input value="0" type="radio" name="usa_fralda" id="usa_fralda" {{ g_old_checked(NULL, "usa_fralda", "0") }}><br>

                        <label class="required">Usa o vaso sanitário?</label><br>
                        <label for="usa_vaso_sanitario">Sim</label>
                        <input value="1" type="radio" name="usa_vaso_sanitario" id="usa_vaso_sanitario" {{ g_old_checked(NULL, "usa_vaso_sanitario", "1") }}>
                        <label for="usa_vaso_sanitario">Não</label>
                        <input value="0" type="radio" name="usa_vaso_sanitario" id="usa_vaso_sanitario" {{ g_old_checked(NULL, "usa_vaso_sanitario", "0") }}><br>

                        <label class="required">Lava as mãos, face e corpo?</label><br>
                        <label for="lava_maos_face_corpo">Sim</label>
                        <input value="1" type="radio" name="lava_maos_face_corpo" id="lava_maos_face_corpo" {{ g_old_checked(NULL, "lava_maos_face_corpo", "1") }}>
                        <label for="lava_maos_face_corpo">Não</label>
                        <input value="0" type="radio" name="lava_maos_face_corpo" id="lava_maos_face_corpo" {{ g_old_checked(NULL, "lava_maos_face_corpo", "0") }}><br>

                        <label class="required">Escova os dentes?</label><br>
                        <label for="escova_dentes">Sim</label>
                        <input value="1" type="radio" name="escova_dentes" id="escova_dentes" {{ g_old_checked(NULL, "escova_dentes", "1") }}>
                        <label for="escova_dentes">Não</label>
                        <input value="0" type="radio" name="escova_dentes" id="escova_dentes" {{ g_old_checked(NULL, "escova_dentes", "0") }}><br>

                        <label class="required">Se diverte com o banho?</label><br>
                        <label for="se_diverte_com_o_banho">Sim</label>
                        <input value="1" type="radio" name="se_diverte_com_o_banho" id="se_diverte_com_o_banho" {{ g_old_checked(NULL, "se_diverte_com_o_banho", "1") }}>
                        <label for="se_diverte_com_o_banho">Não</label>
                        <input value="0" type="radio" name="se_diverte_com_o_banho" id="se_diverte_com_o_banho" {{ g_old_checked(NULL, "se_diverte_com_o_banho", "0") }}><br>

                        <label class="required">Gosta de molhar a cabeça?</label><br>
                        <label for="gosta_molhar_cabeca">Sim</label>
                        <input value="1" type="radio" name="gosta_molhar_cabeca" id="gosta_molhar_cabeca" {{ g_old_checked(NULL, "gosta_molhar_cabeca", "1") }}>
                        <label for="gosta_molhar_cabeca">Não</label>
                        <input value="0" type="radio" name="gosta_molhar_cabeca" id="gosta_molhar_cabeca" {{ g_old_checked(NULL, "gosta_molhar_cabeca", "0") }}><br>

                        <label class="required">Enxuga-se?</label><br>
                        <label for="enxuga_se">Sim</label>
                        <input value="1" type="radio" name="enxuga_se" id="enxuga_se" {{ g_old_checked(NULL, "enxuga_se", "1") }}>
                        <label for="enxuga_se">Não</label>
                        <input value="0" type="radio" name="enxuga_se" id="enxuga_se" {{ g_old_checked(NULL, "enxuga_se", "0") }}><br>

                        <label class="required">Gosta de pentear os cabelos?:</label><br>
                        <label for="gosta_pentear_cabelos">Sim</label>
                        <input value="1" type="radio" name="gosta_pentear_cabelos" id="gosta_pentear_cabelos" {{ g_old_checked(NULL, "gosta_pentear_cabelos", "1") }}>
                        <label for="gosta_pentear_cabelos">Não</label>
                        <input value="0" type="radio" name="gosta_pentear_cabelos" id="gosta_pentear_cabelos" {{ g_old_checked(NULL, "gosta_pentear_cabelos", "0") }}><br>

                        <label class="required">Gosta de cortar os cabelos?</label><br>
                        <label for="gosta_cortar_cabelos">Sim</label>
                        <input value="1" type="radio" name="gosta_cortar_cabelos" id="gosta_cortar_cabelos" {{ g_old_checked(NULL, "gosta_cortar_cabelos", "1") }}>
                        <label for="gosta_cortar_cabelos">Não</label>
                        <input value="0" type="radio" name="gosta_cortar_cabelos" id="gosta_cortar_cabelos" {{ g_old_checked(NULL, "gosta_cortar_cabelos", "0") }}><br>

                        <label class="required">Gosta de cortar as unhas?</label><br>
                        <label for="gosta_cortar_unhas">Sim</label>
                        <input value="1" type="radio" name="gosta_cortar_unhas" id="gosta_cortar_unhas" {{ g_old_checked(NULL, "gosta_cortar_unhas", "1") }}>
                        <label for="gosta_cortar_unhas">Não</label>
                        <input value="0" type="radio" name="gosta_cortar_unhas" id="gosta_cortar_unhas" {{ g_old_checked(NULL, "gosta_cortar_unhas", "0") }}><br>
