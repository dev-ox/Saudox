        ...
        <div class="row">
            ...
            <div style="text-align: center; width: 100%;">
                <div class = "caixa_form">
                    ...
                    <h1>Editar Anamnese PNP de {{$paciente->nome_paciente}}</h1>
                    ...
                    <form style="margin-top: 0px;" method="post" action="{{route('profissional.anamnese.psicopedagogia.editar.salvar')}}">
