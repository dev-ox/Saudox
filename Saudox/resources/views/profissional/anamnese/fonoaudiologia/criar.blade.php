            ...
            <div style="text-align: center; width: 100%;">
                <div class = "caixa_form">
                    ...
                    <form method="post" action="{{route('profissional.anamnese.fonoaudiologia.salvar')}}">
                        ...
                        <input value="1" type="radio" name="crianca_desejada" id="crianca_desejada" {{ g_old_checked(NULL, "crianca_desejada", "1") }}>
                        <label for="crianca_desejada">Não</label>
                        <input value="0" type="radio" name="crianca_desejada" id="crianca_desejada" {{ g_old_checked(NULL, "crianca_desejada", "0") }}><br>
                        ...
                        <input value="Normal" type="radio" name="tipo_parto" id="tipo_parto" {{ g_old_checked(NULL, "tipo_parto", "Normal") }}>
                        <label for="tipo_parto">Cesariana</label>
                        <input value="Cesariana" type="radio" name="tipo_parto" id="tipo_parto" {{ g_old_checked(NULL, "tipo_parto", "Cesariana") }}>
                        <label for="tipo_parto">Fórceps</label>
                        <input value="Fórceps" type="radio" name="tipo_parto" id="tipo_parto" {{ g_old_checked(NULL, "tipo_parto", "Fórceps") }}><br>
                        ...
                        <input value="1" type="radio" name="amamentacao_natural" id="amamentacao_natural" {{ g_old_checked(NULL, "amamentacao_natural", "1") }}>
                        <label for="amamentacao_natural">Artificial</label>
                        <input value="0" type="radio" name="amamentacao_natural" id="amamentacao_natural" {{ g_old_checked(NULL, "amamentacao_natural", "0") }}><br>

                        <hr class="hr_form">
                        <label class="required">Atraso ou problema na fala:</label><br>
                        <label for="atraso_ou_problema_na_fala">Sim</label>
                        <input value="1" type="radio" name="atraso_ou_problema_na_fala" id="atraso_ou_problema_na_fala" {{ g_old_checked(NULL, "atraso_ou_problema_na_fala", "1") }}>
                        <label for="atraso_ou_problema_na_fala">Não</label>
                        <input value="0" type="radio" name="atraso_ou_problema_na_fala" id="atraso_ou_problema_na_fala" {{ g_old_checked(NULL, "atraso_ou_problema_na_fala", "0") }}>

                        <hr class="hr_form">
                        <label class="required">Tem enurese noturna?</label><br>
                        <label for="tem_enurese_noturna">Sim</label>
                        <input value="1" type="radio" name="tem_enurese_noturna" id="tem_enurese_noturna" {{ g_old_checked(NULL, "tem_enurese_noturna", "1") }}>
                        <label for="tem_enurese_noturna">Não</label>
                        <input value="0" type="radio" name="tem_enurese_noturna" id="tem_enurese_noturna" {{ g_old_checked(NULL, "tem_enurese_noturna", "0") }}><br>
                        ...
                        <input value="1" type="radio" name="desenvolvimento_motor_no_tempo_esperado" id="desenvolvimento_motor_no_tempo_esperado" {{ g_old_checked(NULL, "desenvolvimento_motor_no_tempo_esperado", "1") }}>
                        <label for="desenvolvimento_motor_no_tempo_esperado">Não</label>
                        <input value="0" type="radio" name="desenvolvimento_motor_no_tempo_esperado" id="desenvolvimento_motor_no_tempo_esperado" {{ g_old_checked(NULL, "desenvolvimento_motor_no_tempo_esperado", "0") }}><br>
                        ...
                        <input value="1" type="radio" name="perturbacoes_como_pesadelos_sonambulismo_agitacao_etc" id="perturbacoes_como_pesadelos_sonambulismo_agitacao_etc" {{ g_old_checked(NULL, "perturbacoes_como_pesadelos_sonambulismo_agitacao_etc", "1") }}>
                        <label for="perturbacoes_como_pesadelos_sonambulismo_agitacao_etc">Não</label>
                        <input value="0" type="radio" name="perturbacoes_como_pesadelos_sonambulismo_agitacao_etc" id="perturbacoes_como_pesadelos_sonambulismo_agitacao_etc" {{ g_old_checked(NULL, "perturbacoes_como_pesadelos_sonambulismo_agitacao_etc", "0") }}><br>
                        ...
                        <input value="1" type="radio" name="ja_fez_tratamento_fonoaudiologo" id="ja_fez_tratamento_fonoaudiologo" {{ g_old_checked(NULL, "ja_fez_tratamento_fonoaudiologo", "1") }}>
                        <label for="ja_fez_tratamento_fonoaudiologo">Não</label>
                        <input value="0" type="radio" name="ja_fez_tratamento_fonoaudiologo" id="ja_fez_tratamento_fonoaudiologo" {{ g_old_checked(NULL, "ja_fez_tratamento_fonoaudiologo", "0") }}><br>
                        ...
                        <input value="1" type="radio" name="toma_banho_sozinho" id="toma_banho_sozinho" {{ g_old_checked(NULL, "toma_banho_sozinho", "1") }}>
                        <label for="toma_banho_sozinho">Não</label>
                        <input value="0" type="radio" name="toma_banho_sozinho" id="toma_banho_sozinho" {{ g_old_checked(NULL, "toma_banho_sozinho", "0") }}><br>

                        <label class="required">Escova os dentes sozinho:</label><br>
                        <label for="escova_os_dentes_sozinho">Sim</label>
                        <input value="1" type="radio" name="escova_os_dentes_sozinho" id="escova_os_dentes_sozinho" {{g_old_checked(NULL, "escova_os_dentes_sozinho", "1")}}>
                        <label for="escova_os_dentes_sozinho">Não</label>
                        <input value="0" type="radio" name="escova_os_dentes_sozinho" id="escova_os_dentes_sozinho" {{ g_old_checked(NULL, "escova_os_dentes_sozinho", "0") }}><br>

                        <label class="required">Usa o banheiro sozinho:</label><br>
                        <label for="usa_o_banheiro_sozinho">Sim</label>
                        <input value="1" type="radio" name="usa_o_banheiro_sozinho" id="usa_o_banheiro_sozinho" {{ g_old_checked(NULL, "usa_o_banheiro_sozinho", "1") }}>
                        <label for="usa_o_banheiro_sozinho">Não</label>
                        <input value="0" type="radio" name="usa_o_banheiro_sozinho" id="usa_o_banheiro_sozinho" {{ g_old_checked(NULL, "usa_o_banheiro_sozinho", "0") }}><br>
                        ...
                        <input value="1" type="radio" name="necessita_de_auxilio_para_se_vestir_ou_despir" id="necessita_de_auxilio_para_se_vestir_ou_despir" {{ g_old_checked(NULL, "necessita_de_auxilio_para_se_vestir_ou_despir", "1") }}>
                        <label for="necessita_de_auxilio_para_se_vestir_ou_despir">Não</label>
                        <input value="0" type="radio" name="necessita_de_auxilio_para_se_vestir_ou_despir" id="necessita_de_auxilio_para_se_vestir_ou_despir" {{ g_old_checked(NULL, "necessita_de_auxilio_para_se_vestir_ou_despir", "0") }}><br>
                        ...
                        <input value="1" type="radio" name="atende_as_intervencoes_quando_esta_desobedecendo" id="atende_as_intervencoes_quando_esta_desobedecendo" {{ g_old_checked(NULL, "atende_as_intervencoes_quando_esta_desobedecendo", "1") }}>
                        <label for="atende_as_intervencoes_quando_esta_desobedecendo">Não</label>
                        <input value="0" type="radio" name="atende_as_intervencoes_quando_esta_desobedecendo" id="atende_as_intervencoes_quando_esta_desobedecendo" {{ g_old_checked(NULL, "atende_as_intervencoes_quando_esta_desobedecendo", "0") }}><br>

                        <label class="required">Chora fácil:</label><br>
                        <label for="chora_facil">Sim</label>
                        <input value="1" type="radio" name="chora_facil" id="chora_facil" {{ g_old_checked(NULL, "chora_facil", "1") }}>
                        <label for="chora_facil">Não</label>
                        <input value="0" type="radio" name="chora_facil" id="chora_facil" {{ g_old_checked(NULL, "chora_facil", "0") }}><br>

                        <label class="required">Recusa auxílio:</label><br>
                        <label for="recusa_auxilio">Sim</label>
                        <input value="1" type="radio" name="recusa_auxilio" id="recusa_auxilio" {{ g_old_checked(NULL, "recusa_auxilio", "1") }}>
                        <label for="recusa_auxilio">Não</label>
                        <input value="0" type="radio" name="recusa_auxilio" id="recusa_auxilio" {{ g_old_checked(NULL, "recusa_auxilio", "0") }}><br>
                        ...
                        <input value="1" type="radio" name="alfabetizada" id="alfabetizada" {{ g_old_checked(NULL, "alfabetizada", "1") }}>
                        <label for="alfabetizada">Não</label>
                        <input value="0" type="radio" name="alfabetizada" id="alfabetizada" {{ g_old_checked(NULL, "alfabetizada", "0") }}><br><br>
                        ...
                        <input value="1" type="radio" name="repetiu_algum_ano" id="repetiu_algum_ano" {{ g_old_checked(NULL, "repetiu_algum_ano", "1") }}>
                        <label for="repetiu_algum_ano">Não</label>
                        <input value="0" type="radio" name="repetiu_algum_ano" id="repetiu_algum_ano" {{ g_old_checked(NULL, "repetiu_algum_ano", "0") }}><br>
                        ...
                        <input value="Mesmo Sexo" type="checkbox" name="companheiros_da_crianca_nas_brincadeiras[1]" id="mesmo_sexo" {{ g_in_array_old(NULL, "Mesmo Sexo", "companheiros_da_crianca_nas_brincadeiras") }}>
                        <label for="companheiros_da_crianca_nas_brincadeiras">Sexo Oposto</label>
                        <input value="Sexo Oposto" type="checkbox" name="companheiros_da_crianca_nas_brincadeiras[2]" id="sexo_oposto"  {{ g_in_array_old(NULL, "Sexo Oposto", "companheiros_da_crianca_nas_brincadeiras") }} >
                        <label for="companheiros_da_crianca_nas_brincadeiras">Criança da Mesma Idade</label>
                        <input value="Criança da Mesma Idade" type="checkbox" name="companheiros_da_crianca_nas_brincadeiras[3]" id="mesma_idade"{{ g_in_array_old(NULL, "Criança da Mesma Idade", "companheiros_da_crianca_nas_brincadeiras") }} ><br>
                        <label for="companheiros_da_crianca_nas_brincadeiras">Criança Mais Nova</label>
                        <input value="Criança Mais Nova" type="checkbox" name="companheiros_da_crianca_nas_brincadeiras[4]" id="mais_nova"{{ g_in_array_old(NULL, "Criança Mais Nova", "companheiros_da_crianca_nas_brincadeiras") }} >
                        <label for="companheiros_da_crianca_nas_brincadeiras">Criança Mais Velha</label>
                        <input value="Criança Mais Velha" type="checkbox" name="companheiros_da_crianca_nas_brincadeiras[5]" id="mais_velha"{{ g_in_array_old(NULL, "Criança Mais Velha", "companheiros_da_crianca_nas_brincadeiras") }} >
                        <br>
                        ...
                        <input value="Obediente" type="checkbox" name="atitudes_sociais_predominantes[1]" id="obediente" {{ g_in_array_old(NULL, "Obediente", "atitudes_sociais_predominantes") }}>
                        <label for="atitudes_sociais_predominantes">Independente</label>
                        <input value="Independente" type="checkbox" name="atitudes_sociais_predominantes[2]" id="independente" {{ g_in_array_old(NULL, "Independente", "atitudes_sociais_predominantes") }}>
                        <label for="atitudes_sociais_predominantes">Comunicativo</label>
                        <input value="Comunicativo" type="checkbox" name="atitudes_sociais_predominantes[3]" id="comunicativo" {{ g_in_array_old(NULL, "Comunicativo", "atitudes_sociais_predominantes") }}><br>
                        <label for="atitudes_sociais_predominantes">Agressivo</label>
                        <input value="Agressivo" type="checkbox" name="atitudes_sociais_predominantes[4]" id="agressivo" {{ g_in_array_old(NULL, "Agressivo", "atitudes_sociais_predominantes") }}>
                        <label for="atitudes_sociais_predominantes">Cooperador</label>
                        <input value="Cooperador" type="checkbox" name="atitudes_sociais_predominantes[5]" id="cooperador" {{ g_in_array_old(NULL, "Cooperador", "atitudes_sociais_predominantes") }}><br><br>

                        <label class="required">Emocionais:</label><br>
                        <label for="comportamento_emocional">Tranquilo</label>
                        <input value="Tranquilo" type="checkbox" name="comportamento_emocional[1]" id="tranquilo" {{ g_in_array_old(NULL, "Tranquilo", "comportamento_emocional") }}>
                        <label for="comportamento_emocional">Seguro</label>
                        <input value="Seguro" type="checkbox" name="comportamento_emocional[2]" id="seguro" {{ g_in_array_old(NULL, "Seguro", "comportamento_emocional") }}>
                        <label for="comportamento_emocional">Ansioso</label>
                        <input value="Ansioso" type="checkbox" name="comportamento_emocional[3]" id="ansioso" {{ g_in_array_old(NULL, "Ansioso", "comportamento_emocional") }}><br>
                        <label for="comportamento_emocional">Alegre</label>
                        <input value="Alegre" type="checkbox" name="comportamento_emocional[4]" id="alegre" {{ g_in_array_old(NULL, "Alegre", "comportamento_emocional") }}>
                        <label for="comportamento_emocional">Emotivo</label>
                        <input value="Emotivo" type="checkbox" name="comportamento_emocional[5]" id="emotivo" {{ g_in_array_old(NULL, "Emotivo", "comportamento_emocional") }}>
                        <label for="comportamento_emocional">Queixoso</label>
                        <input value="Queixoso" type="checkbox" name="comportamento_emocional[6]" id="queixoso" {{ g_in_array_old(NULL, "Queixoso", "comportamento_emocional") }}><br><br>

                        <label class="required">Sono:</label><br>
                        <label for="comportamento_sono">Insônia</label>
                        <input value="Insônia" type="checkbox" name="comportamento_sono[1]" id="insonia" {{ g_in_array_old(NULL, "Insônia", "comportamento_sono") }}>
                        <label for="comportamento_sono">Pesadelos</label>
                        <input value="Pesadelos" type="checkbox" name="comportamento_sono[2]" id="pesadelos" {{ g_in_array_old(NULL, "Pesadelos", "comportamento_sono") }}>
                        <label for="comportamento_sono">Hipersonia</label>
                        <input value="Hipersonia" type="checkbox" name="comportamento_sono[3]" id="hipersonia" {{ g_in_array_old(NULL, "Hipersonia", "comportamento_sono") }}><br>


                        <label class="required" for="dorme_sozinho">Dorme sozinho</label>
                        <label for="dorme_sozinho">Sim</label>
                        <input value="1" type="radio" name="dorme_sozinho" id="dorme_sozinho" {{ g_old_checked(NULL, "dorme_sozinho", "1") }}>
                        <label for="dorme_sozinho">Não</label>
                        <input value="0" type="radio" name="dorme_sozinho" id="dorme_sozinho" {{ g_old_checked(NULL, "dorme_sozinho", "0") }}>
                        ...
                        <input value="1" type="radio" name="dorme_no_quarto_dos_pais" id="dorme_no_quarto_dos_pais" {{ g_old_checked(NULL, "dorme_no_quarto_dos_pais", "1") }}>
                        <label for="dorme_no_quarto_dos_pais">Não</label>
                        <input value="0" type="radio" name="dorme_no_quarto_dos_pais" id="dorme_no_quarto_dos_pais" {{ g_old_checked(NULL, "dorme_no_quarto_dos_pais", "0") }}>
