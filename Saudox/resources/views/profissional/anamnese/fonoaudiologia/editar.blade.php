        ...
        <div class="row">
            ...
            <div style="text-align: center; width: 100%;">
                <div class = "caixa_form">
                    ...
                    <form method="post" action="{{route('profissional.anamnese.fonoaudiologia.salvar_editar')}}">
                        ...
                        <input value="{{$anamnese->posicao_bloco_familiar}}" placeholder="Posição" type="text" name="posicao_bloco_familiar" id="posicao_bloco_familiar">

                        <label class="required">Criança desejada?</label><br>
                        <label for="crianca_desejada">Sim</label>
                        <input value="0" type="radio" name="crianca_desejada" id="crianca_desejada" {{ old('crianca_desejada', $anamnese->crianca_desejada) == "0" ? "checked" : "" }}>
                        <label for="crianca_desejada">Não</label>
                        <input value="1" type="radio" name="crianca_desejada" id="crianca_desejada" {{ old('crianca_desejada', $anamnese->crianca_desejada) == "1" ? "checked" : "" }}><br>

                        <label class="required">Reação da criança em relação ao status da relação dos pais:</label><br>
                        <input value="{{$anamnese->reacao_crianca_status_relacao_pais}}" placeholder="Reação da criança" type="text" name="reacao_crianca_status_relacao_pais" id="reacao_crianca_status_relacao_pais">

                        <label class="required">Existiam expectativas em relação ao sexo da criança?</label><br>
                        <input value="{{$anamnese->tinha_expectativa_em_relacao_ao_sexo_da_crianca}}" placeholder="Sim, não? Qual?" type="text" name="tinha_expectativa_em_relacao_ao_sexo_da_crianca" id="tinha_expectativa_em_relacao_ao_sexo_da_crianca">

                        <label class="required">Duração da gestação:</label><br>
                        <input value="{{$anamnese->duracao_da_gestacao}}" placeholder="Tempo de gestação" type="text" name="duracao_da_gestacao" id="duracao_da_gestacao">

                        <label class="required">Fez pré natal?</label><br>
                        <input value="{{$anamnese->fez_pre_natal}}" placeholder="Sim? Não? Informações adicionais" type="text" name="fez_pre_natal" id="fez_pre_natal">

                        <label class="required">Tipo de parto:</label><br>
                        <label for="tipo_parto">Normal</label>
                        <input value="Normal" type="radio" name="tipo_parto" id="tipo_parto" {{ old('tipo_parto', $anamnese->tipo_parto) == "Normal" ? "checked" : "" }}>
                        <label for="tipo_parto">Cesariana</label>
                        <input value="Cesariana" type="radio" name="tipo_parto" id="tipo_parto" {{ old('tipo_parto', $anamnese->tipo_parto) == "Cesariana" ? "checked" : "" }}>
                        <label for="tipo_parto">Fórceps</label>
                        <input value="Fórceps" type="radio" name="tipo_parto" id="tipo_parto" {{ old('tipo_parto', $anamnese->tipo_parto) == "Fórceps" ? "checked" : "" }}><br>

                        <label class="required">Houveram complicações durante o parto?</label><br>
                        <input value="{{$anamnese->complicacao_durante_parto}}" placeholder="Sim? Não? Informações adicionais" type="text" name="complicacao_durante_parto" id="complicacao_durante_parto">
                        ...
                        <input value="1" type="radio" name="amamentacao_natural" id="amamentacao_natural" {{ old('amamentacao_natural', $anamnese->amamentacao_natural) == "0" ? "checked" : "" }}>
                        <label for="amamentacao_natural">Artificial</label>
                        <input value="0" type="radio" name="amamentacao_natural" id="amamentacao_natural" {{ old('amamentacao_natural', $anamnese->amamentacao_natural) == "1" ? "checked" : "" }}><br>

                        <label class="required">Atraso ou problema na fala:</label><br>
                        <label for="atraso_ou_problema_na_fala">Sim</label>
                        <input value="0" type="radio" name="atraso_ou_problema_na_fala" id="atraso_ou_problema_na_fala" {{ old('atraso_ou_problema_na_fala', $anamnese->atraso_ou_problema_na_fala) == "0" ? "checked" : "" }}>
                        <label for="atraso_ou_problema_na_fala">Não</label>
                        <input value="1" type="radio" name="atraso_ou_problema_na_fala" id="atraso_ou_problema_na_fala" {{ old('atraso_ou_problema_na_fala', $anamnese->atraso_ou_problema_na_fala) == "1" ? "checked" : "" }}><br>

                        <label class="required">Tem enurese noturna?</label><br>
                        <label for="tem_enurese_noturna">Sim</label>
                        <input value="0" type="radio" name="tem_enurese_noturna" id="tem_enurese_noturna" {{ old('tem_enurese_noturna', $anamnese->tem_enurese_noturna) == "0" ? "checked" : "" }}>
                        <label for="tem_enurese_noturna">Não</label>
                        <input value="1" type="radio" name="tem_enurese_noturna" id="tem_enurese_noturna" {{ old('tem_enurese_noturna', $anamnese->tem_enurese_noturna) == "1" ? "checked" : "" }}><br>
                        ...
                        <input value="0" type="radio" name="desenvolvimento_motor_no_tempo_esperado" id="desenvolvimento_motor_no_tempo_esperado" {{ old('desenvolvimento_motor_no_tempo_esperado', $anamnese->desenvolvimento_motor_no_tempo_esperado) == "0" ? "checked" : "" }}>
                        <label for="desenvolvimento_motor_no_tempo_esperado">Não</label>
                        <input value="1" type="radio" name="desenvolvimento_motor_no_tempo_esperado" id="desenvolvimento_motor_no_tempo_esperado" {{ old('desenvolvimento_motor_no_tempo_esperado', $anamnese->desenvolvimento_motor_no_tempo_esperado) == "1" ? "checked" : "" }}><br>
                        ...
                        <input value="0" type="radio" name="perturbacoes_como_pesadelos_sonambulismo_agitacao_etc" id="perturbacoes_como_pesadelos_sonambulismo_agitacao_etc" {{ old('perturbacoes_como_pesadelos_sonambulismo_agitacao_etc', $anamnese->perturbacoes_como_pesadelos_sonambulismo_agitacao_etc) == "0" ? "checked" : "" }}>
                        <label for="perturbacoes_como_pesadelos_sonambulismo_agitacao_etc">Não</label>
                        <input value="1" type="radio" name="perturbacoes_como_pesadelos_sonambulismo_agitacao_etc" id="perturbacoes_como_pesadelos_sonambulismo_agitacao_etc" {{ old('perturbacoes_como_pesadelos_sonambulismo_agitacao_etc', $anamnese->perturbacoes_como_pesadelos_sonambulismo_agitacao_etc) == "1" ? "checked" : "" }}><br>

                        <label class="required">Troca letras ou fonemas?</label><br>
                        <label for="letras_ou_fonemas_trocados">Sim</label>
                        <input value="Sim" type="radio" name="letras_ou_fonemas_trocados" id="letras_ou_fonemas_trocados" {{ old('letras_ou_fonemas_trocados', $anamnese->letras_ou_fonemas_trocados) == "Sim" ? "checked" : "" }}>
                        <label for="letras_ou_fonemas_trocados">Não</label>
                        <input value="Não" type="radio" name="letras_ou_fonemas_trocados" id="letras_ou_fonemas_trocados" {{ old('letras_ou_fonemas_trocados', $anamnese->letras_ou_fonemas_trocados) == "Não" ? "checked" : "" }}>
                        ...
                        <input value="{{$anamnese->ate_quantos_anos_usou_chupetas}}" placeholder="Ex:. 8 meses" type="text" name="ate_quantos_anos_usou_chupetas" id="ate_quantos_anos_usou_chupetas">
                        ...
                        <input value="0" type="radio" name="ja_fez_tratamento_fonoaudiologo" id="ja_fez_tratamento_fonoaudiologo" {{ old('ja_fez_tratamento_fonoaudiologo', $anamnese->ja_fez_tratamento_fonoaudiologo) == "0" ? "checked" : "" }}>
                        <label for="ja_fez_tratamento_fonoaudiologo">Não</label>
                        <input value="1" type="radio" name="ja_fez_tratamento_fonoaudiologo" id="ja_fez_tratamento_fonoaudiologo" {{ old('ja_fez_tratamento_fonoaudiologo', $anamnese->ja_fez_tratamento_fonoaudiologo) == "1" ? "checked" : "" }}><br>

                        <label class="required">Onde fez o tratamento fonoaudiológico?</label><br>
                        <input value="{{$anamnese->se_sim_tratamento_fono_anterior_onde}}" placeholder="Onde?" type="text" name="se_sim_tratamento_fono_anterior_onde" id="se_sim_tratamento_fono_anterior_onde">

                        <label class="required">Quando fez o tratamento fonoaudiologico?</label><br>
                        <input value="{{$anamnese->se_sim_tratamento_fono_anterior_quando}}" placeholder="Quando?" type="text" name="se_sim_tratamento_fono_anterior_quando" id="se_sim_tratamento_fono_anterior_quando">
                        ...
                        <input value="Sim" type="radio" name="dificuldades_na_fala" id="dificuldades_na_fala" {{ old('dificuldades_na_fala', $anamnese->dificuldades_na_fala) == "Sim" ? "checked" : "" }}>
                        <label for="dificuldades_na_fala">Não</label>
                        <input value="Não" type="radio" name="dificuldades_na_fala" id="dificuldades_na_fala" {{ old('dificuldades_na_fala', $anamnese->dificuldades_na_fala) == "Não" ? "checked" : "" }}>
                        ...
                        <input value="Sim" type="radio" name="dificuldades_na_visao" id="dificuldades_na_visao" {{ old('dificuldades_na_visao', $anamnese->dificuldades_na_visao) == "Sim" ? "checked" : "" }}>
                        <label for="dificuldades_na_visao">Não</label>
                        <input value="Não" type="radio" name="dificuldades_na_visao" id="dificuldades_na_visao" {{ old('dificuldades_na_visao', $anamnese->dificuldades_na_visao) == "Não" ? "checked" : "" }}>
                        <input value="{{ old('anamnese->dificuldades_na_visao') }}" placeholder="Quais?" type="text" name="dificuldades_na_visao-adicional" id="dificuldades_na_visao-adicional">


                        <label class="required">Dificuldade na locomoção:</label><br>
                        <label for="dificuldades_na_locomocao">Sim</label>
                        <input value="Sim" type="radio" name="dificuldades_na_locomocao" id="dificuldades_na_locomocao" {{ old('dificuldades_na_locomocao', $anamnese->dificuldades_na_locomocao) == "Sim" ? "checked" : "" }}>
                        <label for="dificuldades_na_locomocao">Não</label>
                        <input value="Não" type="radio" name="dificuldades_na_locomocao" id="dificuldades_na_locomocao" {{ old('dificuldades_na_locomocao', $anamnese->dificuldades_na_locomocao) == "Não" ? "checked" : "" }}>
                        ...
                        <input value="0" type="radio" name="toma_banho_sozinho" id="toma_banho_sozinho" {{ old('toma_banho_sozinho', $anamnese->toma_banho_sozinho) == "0" ? "checked" : "" }}>
                        <label for="toma_banho_sozinho">Não</label>
                        <input value="1" type="radio" name="toma_banho_sozinho" id="toma_banho_sozinho" {{ old('toma_banho_sozinho', $anamnese->toma_banho_sozinho) == "1" ? "checked" : "" }}><br>

                        <label class="required">Escova os dentes sozinho:</label><br>
                        <label for="escova_os_dentes_sozinho">Sim</label>
                        <input value="0" type="radio" name="escova_os_dentes_sozinho" id="escova_os_dentes_sozinho" {{ old('escova_os_dentes_sozinho', $anamnese->escova_os_dentes_sozinho) == "0" ? "checked" : "" }}>
                        <label for="escova_os_dentes_sozinho">Não</label>
                        <input value="1" type="radio" name="escova_os_dentes_sozinho" id="escova_os_dentes_sozinho" {{ old('escova_os_dentes_sozinho', $anamnese->escova_os_dentes_sozinho) == "1" ? "checked" : "" }}><br>

                        <label class="required">Usa o banheiro sozinho:</label><br>
                        <label for="usa_o_banheiro_sozinho">Sim</label>
                        <input value="0" type="radio" name="usa_o_banheiro_sozinho" id="usa_o_banheiro_sozinho" {{ old('usa_o_banheiro_sozinho', $anamnese->usa_o_banheiro_sozinho) == "0" ? "checked" : "" }}>
                        <label for="usa_o_banheiro_sozinho">Não</label>
                        <input value="1" type="radio" name="usa_o_banheiro_sozinho" id="usa_o_banheiro_sozinho" {{ old('usa_o_banheiro_sozinho', $anamnese->usa_o_banheiro_sozinho) == "1" ? "checked" : "" }}><br>
                        ...
                        <input value="0" type="radio" name="necessita_de_auxilio_para_se_vestir_ou_despir" id="necessita_de_auxilio_para_se_vestir_ou_despir" {{ old('necessita_de_auxilio_para_se_vestir_ou_despir', $anamnese->necessita_de_auxilio_para_se_vestir_ou_despir) == "0" ? "checked" : "" }}>
                        <label for="necessita_de_auxilio_para_se_vestir_ou_despir">Não</label>
                        <input value="1" type="radio" name="necessita_de_auxilio_para_se_vestir_ou_despir" id="necessita_de_auxilio_para_se_vestir_ou_despir" {{ old('necessita_de_auxilio_para_se_vestir_ou_despir', $anamnese->necessita_de_auxilio_para_se_vestir_ou_despir) == "1" ? "checked" : "" }}><br>
                        ...
                        <input value="0" type="radio" name="atende_as_intervencoes_quando_esta_desobedecendo" id="atende_as_intervencoes_quando_esta_desobedecendo" {{ old('atende_as_intervencoes_quando_esta_desobedecendo', $anamnese->atende_as_intervencoes_quando_esta_desobedecendo) == "0" ? "checked" : "" }}>
                        <label for="atende_as_intervencoes_quando_esta_desobedecendo">Não</label>
                        <input value="1" type="radio" name="atende_as_intervencoes_quando_esta_desobedecendo" id="atende_as_intervencoes_quando_esta_desobedecendo" {{ old('atende_as_intervencoes_quando_esta_desobedecendo', $anamnese->atende_as_intervencoes_quando_esta_desobedecendo) == "1" ? "checked" : "" }}><br>

                        <label class="required">Chora fácil:</label><br>
                        <label for="chora_facil">Sim</label>
                        <input value="0" type="radio" name="chora_facil" id="chora_facil" {{ old('chora_facil', $anamnese->chora_facil) == "0" ? "checked" : "" }}>
                        <label for="chora_facil">Não</label>
                        <input value="1" type="radio" name="chora_facil" id="chora_facil" {{ old('chora_facil', $anamnese->chora_facil) == "1" ? "checked" : "" }}><br>

                        <label class="required">Recusa auxílio:</label><br>
                        <label for="recusa_auxílio">Sim</label>
                        <input value="0" type="radio" name="recusa_auxílio" id="recusa_auxílio" {{ old('recusa_auxílio', $anamnese->recusa_auxílio) == "0" ? "checked" : "" }}>
                        <label for="recusa_auxílio">Não</label>
                        <input value="1" type="radio" name="recusa_auxílio" id="recusa_auxílio" {{ old('recusa_auxílio', $anamnese->recusa_auxílio) == "1" ? "checked" : "" }}><br>

                        <label class="required">Resistência ao toque (Afago, carinho):</label><br>
                        <label for="tem_resistencia_ao_toque">Sim</label>
                        <input value="Sim" type="radio" name="tem_resistencia_ao_toque" id="tem_resistencia_ao_toque" {{ old('tem_resistencia_ao_toque', $anamnese->tem_resistencia_ao_toque) == "0" ? "checked" : "" }}>
                        <label for="tem_resistencia_ao_toque">Não</label>
                        <input value="Não" type="radio" name="tem_resistencia_ao_toque" id="tem_resistencia_ao_toque" {{ old('tem_resistencia_ao_toque', $anamnese->tem_resistencia_ao_toque) == "1" ? "checked" : "" }}>
                        ...
                        <input value="{{$anamnese->serie_atual_na_escola}}" placeholder="Série atual" type="text" name="serie_atual_na_escola" id="serie_atual_na_escola">

                        <label class="required">Alfabetizada?</label><br>
                        <label for="alfabetizada">Sim</label>
                        <input value="0" type="radio" name="alfabetizada" id="alfabetizada" {{ old('alfabetizada', $anamnese->alfabetizada) == "0" ? "checked" : "" }}>
                        <label for="alfabetizada">Não</label>
                        <input value="1" type="radio" name="alfabetizada" id="alfabetizada" {{ old('alfabetizada', $anamnese->alfabetizada) == "1" ? "checked" : "" }}><br><br>
                        ...
                        <input value="0" type="radio" name="repetiu_algum_ano" id="repetiu_algum_ano" {{ old('repetiu_algum_ano', $anamnese->repetiu_algum_ano) == "0" ? "checked" : "" }}>
                        <label for="repetiu_algum_ano">Não</label>
                        <input value="1" type="radio" name="repetiu_algum_ano" id="repetiu_algum_ano" {{ old('repetiu_algum_ano', $anamnese->repetiu_algum_ano) == "1" ? "checked" : "" }}><br>
                        ...
                        <input value="Sim" type="radio" name="adapta_se_facilmente_ao_meio" id="adapta_se_facilmente_ao_meio" {{ old('adapta_se_facilmente_ao_meio', $anamnese->adapta_se_facilmente_ao_meio) == "Sim" ? "checked" : "" }}>
                        <label for="adapta_se_facilmente_ao_meio">Não</label>
                        <input value="Não" type="radio" name="adapta_se_facilmente_ao_meio" id="adapta_se_facilmente_ao_meio" {{ old('adapta_se_facilmente_ao_meio', $anamnese->adapta_se_facilmente_ao_meio) == "Não" ? "checked" : "" }}>
                        ...
                        <input value="0" type="radio" name="dorme_sozinho" id="dorme_sozinho" {{ old('dorme_sozinho', $anamnese->dorme_sozinho) == "0" ? "checked" : "" }}>
                        ...
                        <input value="0" type="radio" name="dorme_no_quarto_dos_pais" id="dorme_no_quarto_dos_pais" {{ old('dorme_no_quarto_dos_pais', $anamnese->dorme_no_quarto_dos_pais) == "0" ? "checked" : "" }}>
