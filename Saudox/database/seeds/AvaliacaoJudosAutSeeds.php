    ...
    public function run()
    {
        ...
        for($i = 0; $i < $qtd; $i++){
          DB::table('avaliacao__judos')->insert([
            'id' => $i,
            'id_paciente' => rand(0,9), // MUDAR RANGE A DEPENDER DA QUANTIDADE DE PACIENTES GERADOS
            'id_profissional' => rand(0,9), // MUDAR RANGE A DEPENDER DA QUANTIDADE DE PROFISSIONAIS GERADOS
            'diagnóstico' => Str::random(100),
            ...
            'comunicação_verbal' => Str::random(15),
            ...
            'equilíbrio' => Str::random(15),
            'forca' => Str::random(15),
            'resistência' => Str::random(15),
            ...
            'concentração' => Str::random(15),
            'comportamento_reflexo' => Str::random(15),
            'observações' => Str::random(100),
