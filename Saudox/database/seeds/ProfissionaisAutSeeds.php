...
class ProfissionaisAutSeeds extends Seeder {
    ...
    public function run() {
        ...
        $profissao = ['Administrador', 'Recepcionista', 'Fonoaudiólogo', 'Terapeuta Ocupacional', 'Neuropsicólogo', 'Psicólogo', 'Psicopedagogo'];
        $estado_civil = ['Solteiro(a)', 'Casado(a)', '(a)', 'Separado(a)', 'Divorciado(a)', 'Viúvo(a)', 'Amasiado(a)'];
